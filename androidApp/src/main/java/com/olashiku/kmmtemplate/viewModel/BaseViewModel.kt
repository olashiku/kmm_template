...
//        responseKey: String, apiCall: suspend () -> NetworkResult<T>,
...
//            when (result) {
//                is NetworkResult.Success<*> -> {
//                    saveStateHandle.getStateFlow(responseKey, result.data as T)
//                }
//                is NetworkResult.Errror -> {
//                    saveStateHandle.getStateFlow("errorMessage", result.exception.message)
//                }
//                is NetworkResult.Failed<*> -> {
//                    saveStateHandle.getStateFlow("errorMessage", getError(result as T))
//                }
//                else -> {}
//            }
//        }
